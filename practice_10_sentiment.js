// previous problem did not account for words that were just different forms of the word
// use regex to make the relationship between variants more evident.
...
function sentiment(text) {
  ...
  let positiveList = wordList.filter( (word) => word.match(positiveRegex) );
  let negativeList = wordList.filter( (word) => word.match(negativeRegex) );
